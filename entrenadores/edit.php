...
include("../app/controllers/entrenadores/edit_entrenador_data.php");
            ...
            <div class="card-body" style="display: block;">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <form action="../app/controllers/entrenadores/update_entrenador_process.php" method="post"
                    enctype="multipart/form-data">

                    <input type="hidden" name="id_entrenador" value="<?php echo $entrenador_data['id_entrenador']; ?>">
                    <input type="hidden" name="foto_actual" value="<?php echo $entrenador_data['foto']; ?>">

                    <div class="form-group">
                      <center><output id="list"><img class="thumb thumbnail"
                            src="<?php echo $URL . '/public/images/entrenadores/' . $entrenador_data['foto']; ?>"
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nombre" class="form-control"
                        value="<?php echo $entrenador_data['nombre']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="">Apellido Paterno</label>
                      <input type="text" name="ape_pat" class="form-control"
                        value="<?php echo $entrenador_data['ape_pat']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="">Apellido Materno</label>
                      <input type="text" name="ape_mat" class="form-control"
                        value="<?php echo $entrenador_data['ape_mat']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="">DNI</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="telefono" class="form-control"
                        value="<?php echo $entrenador_data['telefono']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="">Email</label>
                      <input type="text" name="email" class="form-control"
                        value="<?php echo $entrenador_data['email']; ?>" required>
                    </div>
