...
// MODIFICACIÓN: Se añade la subconsulta para obtener la fecha de fin de la última matrícula.
$sql_clientes = "SELECT 
                ...
                WHERE id_cliente = '$id_cliente_get' AND cli.id_gimnasio = '$_SESSION[id_gimnasio_sesion]' ";
  ...
  foreach($clientes_datos as $clientes_dato) {
    // La variable $codigo ahora obtiene el valor de id_cliente gracias al alias en el SELECT.
    ...
    // Nueva variable con la fecha de fin de la última matrícula
    $fecha_fin_ultima_matricula = $clientes_dato['fecha_fin_ultima_matricula'];
  }
?>