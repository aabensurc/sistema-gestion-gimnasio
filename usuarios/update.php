...
include("../app/controllers/usuarios/edit_usuario_data.php");
            ...
            <div class="card-body" style="display: block;">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <form action="../app/controllers/usuarios/update_usuario_process.php" method="post"
                    enctype="multipart/form-data">


                    <div class="form-group">
                      <center><output id="list"><img class="thumb thumbnail"
                            src="../public/images/usuarios/<?php echo $foto ?>" width="200px"></output></center>
