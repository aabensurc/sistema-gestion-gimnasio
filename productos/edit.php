...
include("../app/controllers/productos/edit_producto_data.php");
        ...
        <div class="col-md-5">
          <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title">Modifique los datos del producto</h3>
            ...
            <div class="card-body" style="display: block;">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <form action="../app/controllers/productos/update_producto_process.php" method="post"
                    enctype="multipart/form-data">

                    <input type="hidden" name="id_producto" value="<?php echo $producto_data['id_producto']; ?>">
                    <input type="hidden" name="foto_actual" value="<?php echo $producto_data['foto']; ?>">

                    <div class="form-group">
                      <center><output id="list"><img class="thumb thumbnail"
                            src="<?php echo $URL . '/public/images/productos/' . $producto_data['foto']; ?>"
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="descripcion" class="form-control"
                        rows="3"><?php echo $producto_data['descripcion']; ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="">Precio Venta (S/.)</label>
                      <input type="number" name="precio_venta" class="form-control"
                        value="<?php echo number_format($producto_data['precio_venta'], 2, '.', ''); ?>" step="0.01"
                        required>
                    </div>
                    <div class="form-group">
